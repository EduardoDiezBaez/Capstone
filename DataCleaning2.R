...
new.abbr <- data.frame(abv = c("Mr.", "Mrs.", "Ms.", "i.e.", "A.D.", "B.C.", "A.M.", "P.M.", "et al.", "Jr.", "Dr.", "Sr.", "Sen.", "U.S.", "U.S.A.", "p.s.", "w/", "&"), rep = c("Mr", "Mrs", "Ms", "ie", "AD", "BC", "AM", "PM", "et al", "Jr", "Dr", "Sr", "Sen", "USA", "USA", "ps", "with", "and"))
...
preproc <- tm_map(preproc, content_transformer(replace_number))

# 4.3. Remove URLs

removeURL <- function(x) gsub("www.[A-z0-9]+.[a-z]{2,}", "", x)
...
# 4.6. Remove intra word dashes and dollar signs
...
preproc <- tm_map(preproc, content_transformer(sent_detect), endmarks = c("?", ".", "!", "|", "…", ":"), language = "en")
